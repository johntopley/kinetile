...
export const CUES = {
  ...
  pause: [{ frequency: 392, duration: 0.09, type: "sine", gain: 0.05, glide: 247 }],
  resume: [{ frequency: 247, duration: 0.09, type: "sine", gain: 0.05, glide: 392 }],
  save: [
    { frequency: 523, duration: 0.07, type: "triangle", gain: 0.05 },
    { frequency: 784, duration: 0.12, type: "triangle", gain: 0.06, delay: 0.06 }
  ],
  load: [
    { frequency: 392, duration: 0.07, type: "triangle", gain: 0.05 },
    { frequency: 523, duration: 0.1, type: "triangle", gain: 0.05, delay: 0.07 }
  ],
  powerWIDE: [
