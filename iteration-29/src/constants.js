...
export const SAVE_KEY = "kinetile-save";
...
export const BALL_SLOW_SCALE = 0.5;
export const GATE_HEIGHT = 88;
export const GATE_TOP = HEIGHT - GATE_HEIGHT;
export const BARRIER_Y = HEIGHT - 22;
export const MAGNET_MIN_Y = HEIGHT * 0.55;
export const MAGNET_RANGE = 280;
export const MAGNET_PULL = 900;
