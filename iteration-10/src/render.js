...
function drawTitle(ctx, logo) {
  ...
  ctx.fillText("ITERATION 10 — PIERCE", WIDTH / 2, 400);
  ctx.font = "18px 'Segoe UI', sans-serif";
  ctx.fillStyle = COLOURS.muted;
  ctx.fillText("A gold capsule lets the ball slice through bricks.", WIDTH / 2, 432);
...
function drawPlayfield(ctx, game) {
  ...
  drawBall(ctx, game.ball, game.effects.pierce > 0);
}
